...
/**
 * This class parses commands based off patterns. Based off template code from
 * Robert Duvall.
 * 
 * @author Daniel Chai
 */
public class CommandParser {
	...
	/**
	 * Use the Constructor that takes in a resource file name instead of using
	 * the default then addPatterns() Adds the given resource file to this
	 * language's recognized types
	 */
